        ...
        child: InkWell(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
              vertical: AppSetting.setWidth((verticalPadding ?? (AppSetting.isTablet(context) ? 30 : 35))),
      ...
      children: [
        ...
        title!.isNotEmpty
          ...
          style: useBold
            ...
            fontSize: AppSetting.setFontSize(fontSize) - (AppSetting.isTablet(context) ? 4 : 0),
