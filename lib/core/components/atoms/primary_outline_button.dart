        ...
        child: InkWell(
          ...
          child: Padding(
            padding: EdgeInsets.symmetric(
              ...
              horizontal: AppSetting.setHeight(horizontalPadding == null ? 10 : horizontalPadding!),
            ),
            child: Row(
              ...
              children: [
                ...
                SizedBox(
                  width: AppSetting.setWidth(iconPath != null ? rightIconPadding : 60),
                )
              ],
            ),
          ),
